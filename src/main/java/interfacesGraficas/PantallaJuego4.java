...
public class PantallaJuego4 extends JPanel {
	 ...
	 * @param ventana 
	 */
	public PantallaJuego4(Ventana v, Clip clip) {
		this.ventana=v;
		try {
		...
		fondoJuego.setIcon(new ImageIcon(PantallaJuego4.class.getResource("/imagenes/fondo con logo.png")));
