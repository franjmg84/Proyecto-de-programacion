...
public class PantallaJuego6 extends JPanel {
	 ...
	 * @param ventana 
	 */
	public PantallaJuego6(Ventana v, Clip clip) {
		this.ventana=v;
		try {
		...
		fondoJuego.setIcon(new ImageIcon(PantallaJuego6.class.getResource("/imagenes/fondo con logo.png")));
