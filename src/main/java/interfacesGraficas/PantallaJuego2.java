...
public class PantallaJuego2 extends JPanel {
	 ...
	 * @param ventana 
	 */
	public PantallaJuego2(Ventana v, Clip clip) {
		this.ventana=v;
		try {
		...
		BotonAzul BotonConSonido = new BotonAzul("Play");
		...
		fondoJuego.setIcon(new ImageIcon(PantallaJuego2.class.getResource("/imagenes/fondo juego rockola.png")));
