...
public class PantallaJuego8 extends JPanel {
	 ...
	 * @param ventana 
	 */
	public PantallaJuego8(Ventana v, Clip clip) {
		this.ventana=v;
		try {
		...
		fondoJuego.setIcon(new ImageIcon(PantallaJuego8.class.getResource("/imagenes/fondo con logo.png")));
