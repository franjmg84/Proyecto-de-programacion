...
public class PantallaJuego7 extends JPanel {
	 ...
	 * @param ventana 
	 */
	public PantallaJuego7(Ventana v, Clip clip) {
		this.ventana=v;
		try {
		...
		fondoJuego.setIcon(new ImageIcon(PantallaJuego7.class.getResource("/imagenes/fondo con logo.png")));
